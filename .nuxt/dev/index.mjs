...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file://D:/nuxt/cactus/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file://D:/nuxt/cactus/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file://D:/nuxt/cactus/node_modules/devalue/index.js';
import destr from 'file://D:/nuxt/cactus/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash } from 'file://D:/nuxt/cactus/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file://D:/nuxt/cactus/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file://D:/nuxt/cactus/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file://D:/nuxt/cactus/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file://D:/nuxt/cactus/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file://D:/nuxt/cactus/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file://D:/nuxt/cactus/node_modules/hookable/dist/index.mjs';
import { klona } from 'file://D:/nuxt/cactus/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file://D:/nuxt/cactus/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file://D:/nuxt/cactus/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file://D:/nuxt/cactus/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file://D:/nuxt/cactus/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file://D:/nuxt/cactus/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file://D:/nuxt/cactus/node_modules/consola/dist/index.mjs';
import devalue from 'file://D:/nuxt/cactus/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { getContext } from 'file://D:/nuxt/cactus/node_modules/unctx/dist/index.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file://D:/nuxt/cactus/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file://D:/nuxt/cactus/node_modules/pathe/dist/index.mjs';
import { version, unref } from 'file://D:/nuxt/cactus/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file://D:/nuxt/cactus/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file://D:/nuxt/cactus/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"D:/nuxt/cactus/server/assets"}];
...
const rootDir = "D:/nuxt/cactus";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _zGjuWqykSs = (nitroApp) => {
...
const _CrtIeS = lazyEventHandler(() => {
...
const _lazy_XWGEEb = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_XWGEEb, lazy: true, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _CrtIeS, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_XWGEEb, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://D:/nuxt/cactus/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file://D:/nuxt/cactus/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
